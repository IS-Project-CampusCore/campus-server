...
public class UpdateGradesFromExcel(ILogger<UpdateGradesFromExcel> logger) : CampusEndpoint<FileRequest>(logger)
{
    public gradesService.gradesServiceClient Client { get; set; } = default!;

    public override void Configure()
    {
        Post("api/grades/update-excel");
    ...
    public override async Task HandleAsync(FileRequest req, CancellationToken cancellationToken)
    {
        ...
        var grpcRequest = new UpdateGradesFromExcelRequest
        {
        ...
        MessageResponse grpcResponse = await Client.UpdateGradesFromExcelAsync(grpcRequest, null, null, cancellationToken);
